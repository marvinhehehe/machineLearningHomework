...
if __name__ == '__main__':
    ...
    train_data, test_data, train_label, test_label = sklearn.model_selection.train_test_split(trainData, trainLabel,
                                                                                              ...
                                                                                              train_size=0.7,
                                                                                              test_size=0.3)
    classifier = svm.SVC(C=2, kernel='rbf', gamma='auto', decision_function_shape='ovo')
    #classifier = svm.SVC(C=2, kernel='poly', gamma='auto', decision_function_shape='ovo')
    #classifier = svm.SVC(C=2, kernel='linear', decision_function_shape='ovo')
